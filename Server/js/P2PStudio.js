/**
 * P2PStudio -- An Open Source peer to peer audio streaming solution
...
const STUDIO_ID = "JerrysHouse";
//set to true if Server mode
var isServer=true;
    ...
    constructor(p) {
        ...
        this.peer.on("call",   // when we get an incoming call
            function(mediaConnection) {
                ...
                // removed checking to see if user wants to connect
...
function onCallStreamIncoming(remoteStream) {
    ...
    //console.log("In onCallStreamIncoming, stream: " + remoteStream);
